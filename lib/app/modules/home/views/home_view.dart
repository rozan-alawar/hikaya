...
class HomeView extends GetView<HomeController> {
  ...
  Widget build(BuildContext context) {
    return Obx(() => Scaffold(
      ...
      appBar: AppBar(
        ...
        leading:  controller.currentIndex.value==2? Container(child: Icon(Icons.notifications_none_outlined),margin: EdgeInsets.symmetric(horizontal: 12),): 0.ph(),
        centerTitle: true,
        title: AppText(text: getAppBarText(controller.currentIndex.value),  fontSize: 20,fontWeight: FontWeight.bold,) ,
        actions: [
          Container(
            ...
            child: const Center(child: Icon(Icons.arrow_back_ios,textDirection: TextDirection.ltr,),),
          )
        ],
      ),
    ...
    return SafeArea(
        child: Padding(padding: const EdgeInsets.symmetric(horizontal: 20),child: Column(
          ...
          children: [
            Column(
              children: [
                AppText(text: ' ابدأ الآن واكتشف تجربة تعليمية ممتعة دليلك بين يديك في مكان واحد', fontSize: 25,)
               , Image.asset('assets/images/line_under_text.png',height: 10.3,width: 63,)
              ],
            ),

            50.ph(),
            Expanded(
                child: ListView.separated(itemBuilder: (context, index) => _buildHomeWidget(
                ...
                ), separatorBuilder:(context, index) => 16.ph(), itemCount: AppDummyData.HomeData.length)
            ),
    ...
    return SafeArea(
        child: Padding(padding: EdgeInsets.symmetric(horizontal: 20),child: Column(
          ...
          children: [
            40.ph(),
            Expanded(
                child: ListView.separated(itemBuilder: (context, index) => _buildHomeCategoryWidget(
                ...
                ), separatorBuilder:(context, index) => 40.ph(), itemCount: AppDummyData.categoryHomeData.length)
            ),
        ...
        child: Padding(padding: EdgeInsets.symmetric(horizontal: 20),child: Column(
          ...
          children: [
            Container(
              ...
              child: Icon(Icons.person_outline,size: 200,color: Color(0xff1E6C41),),
            ),
            SizedBox(
              height: 14,
            ),
            ...
            Expanded(
              flex: 8,
                child: ListView.separated(itemBuilder: (context, index) => _buildProfileWidget(
                  image: 'assets/images/flag1.png',
                  title: 'البلاد والكثبان الرملية معامله',
                  subtitle: 'للطلبات من للتعاملات',
                  price: '115.99',
                  rating: '4.8',
                ), separatorBuilder:(context, index) =>  const SizedBox(height: 16,), itemCount: 7)
            ),
  ...
  Widget _buildHomeWidget({
    ...
    return Container(
      ...
      child: Padding(padding: EdgeInsets.symmetric(horizontal: 8,vertical: 12),child: Row(
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  AppText(text:date, fontSize: 13,  color: const Color(0xff7D848D))
